"""
pythological changed into Prolog semantics instead of miniKanren.
I don't intend to maintain this in parallel -- it's for explanation
only.
"""
...
def gen_solutions(var, goal):
    ...
    return (reify(var, s) for s in goal(empty_s))


# Goals

# A goal is a function from substitution to generator of substitutions.
...
def either(goal1, goal2):
    ...
    return lambda s: chain(goal1(s), goal2(s))
